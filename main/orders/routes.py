...
urlpatterns = [
	...
	path('pedidos/', views.show_orders, name='show_orders'),
	...
	path('pedidos/<int:order_id>/detalles/editar/', views.order_detail, name='order_detail_edit'),
    path('pedidos/<int:order_id>/editar/', views.edit_order, name='edit_order'),
    
    path('pedidos/<int:order_id>/eliminar/', views.delete_order, name='delete_order'),
